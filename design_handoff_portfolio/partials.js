...
(function () {
  ...
  const NAV = `
    <header class="navbar" id="navbar" data-screen-label="Nav">
      <div class="nav-inner">
        <a href="${link('Portfolio Animated.html')}#top" class="brand" aria-label="Meet Patel, home">
        ...
        <nav aria-label="Primary">
          <ul class="nav-links">
            ...
            <li><a href="${link('Portfolio Animated.html')}#services" data-nav="services">Services</a></li>
    ...
    <div class="mobile-menu" id="mobileMenu" role="dialog" aria-modal="true" aria-label="Menu">
      ...
      <a href="${link('Portfolio Animated.html')}#services">Services</a>
      ...
      <div class="container">
        ...
        <div class="footer-grid">
          <div class="footer-col footer-col-brand">
            <a href="${link('Portfolio Animated.html')}#top" class="footer-wordmark">Meet Patel</a>
          ...
          <div class="footer-col">
            ...
            <ul>
              <li><a href="${link('Portfolio Animated.html')}">Home</a></li>
              ...
              <li><a href="${link('Portfolio Animated.html')}#services">Services</a></li>
